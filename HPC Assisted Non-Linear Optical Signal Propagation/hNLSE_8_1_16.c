...
int main(void)
{
	...
	double NSpS = 64;											//Number of Samples per Symbol
	int N_spans = 5;											//Number of span divisions
	...
	for (int PchdBm_index = (int)Pch_dBm_min; PchdBm_index <= (int)Pch_dBm_max; PchdBm_index+=6)
	{
