...
int main(void)
{
	...
	double NSpS = 256;											//Number of Samples per Symbol
	...
	double Pch_dBm_min = -4;
	//double Pch_dBm_max = 2;
	...
	for (int PchdBm_index = (int)Pch_dBm_min; PchdBm_index <= (int)Pch_dBm_min; PchdBm_index+=6)
	{
		...
		printf("\n\nPch =  %d    Time taken with %d threads =   %.6f sec\n\n", PchdBm_index, thread_count, elapsed);
